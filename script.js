...
//   return favorites.includes(Number(foodID))
// }
...
const foodCards = (foodArray) => {
  ...
  for (let index = 0; index < foodArray.length; index++) {
    ...
    show.innerHTML += `
          <div class="bg-white dark:bg-gray-800 rounded-2xl cursor-pointer overflow-hidden shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 pb-5 relative z-10" title="Click for more information" onclick="foodID(${foodData.id})">
  ...
  document.getElementById('modalDetails').innerHTML = `
    <div
              ...
              <div class="p-6 flex flex-col justify-between">
                <div>
                  ...
                  <h4 class="text-md font-bold font-serif text-gray-400 dark:text-white mb-2"> ~ ${food.category} ~ ${food.region}</h4>
    ...
    <a class="bg-gray-100 text-black border-l-8 border-green-500 rounded-md px-3 py-2 w-full"
      ...
      <div class="text-gray-500 font-thin text-sm">
        ...
        <button class="bg-teal-600 hover:bg-teal-700 text-white font-semibold px-4 py-2 rounded-lg transition"><i class="fa-regular fa-heart" style="color: #ffffff;"></i>Add to Favorites</button>
      </div>
...
document.getElementById('showYear').innerHTML = `${today.getFullYear()}`